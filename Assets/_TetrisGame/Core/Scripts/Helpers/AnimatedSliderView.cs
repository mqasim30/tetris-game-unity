...
namespace TetrisGame.Core.Scripts.Helpers
{
    public class AnimatedSliderView : MonoBehaviour
    {
        ...
        public async Awaitable AnimateSliderTo(float targetValueBetween0To1,
            CancellationTokenSource cancellationTokenSource)
        {
            _currentAnimationTween?.Kill();
            _currentAnimationTween =
                _slider.DOValue(targetValueBetween0To1, _animationDuration).SetEase(_animationEase);
